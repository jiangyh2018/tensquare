...
public class RecruitController {
    ...
    public Result searchNewRecrutList() {
        List<Recruit> recruitList = recruitService.findTop6ByStateNotOrderByCreatetimeDesc("0");
    ...
    public Result searchByState(@RequestParam(name = "state",defaultValue = "2",required = false) String  s) {
        List<Recruit> recruitList = recruitService.searchByState(s);
        return new Result(true,StatusCode.OK,"查询成功",recruitList);
    }
